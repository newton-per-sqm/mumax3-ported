...
.visible .entry adddmi(
	...
	.param .u16 adddmi_param_17,
	.param .u16 adddmi_param_18
)
{
	.reg .pred 	%p<50>;
	.reg .b16 	%rs<33>;
	...
	ld.param.u16 	%rs13, [adddmi_param_17];
	ld.param.u16 	%rs14, [adddmi_param_18];
...
$L__BB0_7:
	...
	ld.global.nc.u16 	%rs29, [%rd28];

$L__BB0_9:
	min.u16 	%rs15, %rs29, %rs1;
	cvt.u32.u16 	%r50, %rs15;
	max.u16 	%rs16, %rs29, %rs1;
...
$L__BB0_18:
	...
	ld.global.nc.u16 	%rs30, [%rd37];

$L__BB0_20:
	min.u16 	%rs17, %rs30, %rs1;
	cvt.u32.u16 	%r59, %rs17;
	max.u16 	%rs18, %rs30, %rs1;
...
$L__BB0_29:
	...
	ld.global.nc.u16 	%rs31, [%rd46];

$L__BB0_31:
	min.u16 	%rs19, %rs31, %rs1;
	cvt.u32.u16 	%r68, %rs19;
	max.u16 	%rs20, %rs31, %rs1;
	cvt.u32.u16 	%r69, %rs20;
	add.s32 	%r70, %r69, 1;
...
$L__BB0_40:
	...
	mul.wide.s32 	%rd54, %r26, 2;
	add.s64 	%rd55, %rd3, %rd54;
	ld.global.nc.u16 	%rs32, [%rd55];

$L__BB0_42:
	min.u16 	%rs21, %rs32, %rs1;
	cvt.u32.u16 	%r78, %rs21;
	max.u16 	%rs22, %rs32, %rs1;
...
$L__BB0_50:
	...
	mul.wide.s32 	%rd59, %r87, 4;
	add.s64 	%rd60, %rd6, %rd59;
	add.s64 	%rd61, %rd5, %rd59;
	add.s64 	%rd62, %rd4, %rd59;
	ld.global.nc.f32 	%f224, [%rd62];
	ld.global.nc.f32 	%f225, [%rd60];
	ld.global.nc.f32 	%f226, [%rd61];
	...
	mul.wide.s32 	%rd63, %r87, 2;
	add.s64 	%rd64, %rd3, %rd63;
	ld.global.nc.u16 	%rs23, [%rd64];
	min.u16 	%rs24, %rs23, %rs1;
	cvt.u32.u16 	%r88, %rs24;
	max.u16 	%rs25, %rs23, %rs1;
...
$L__BB0_53:
	...
	ld.global.nc.f32 	%f239, [%rd70];
	ld.global.nc.f32 	%f240, [%rd68];
	ld.global.nc.f32 	%f241, [%rd69];
	...
	mul.wide.s32 	%rd71, %r98, 2;
	add.s64 	%rd72, %rd3, %rd71;
	ld.global.nc.u16 	%rs26, [%rd72];
	min.u16 	%rs27, %rs26, %rs1;
	cvt.u32.u16 	%r99, %rs27;
	max.u16 	%rs28, %rs26, %rs1;
	cvt.u32.u16 	%r100, %rs28;
	add.s32 	%r101, %r100, 1;
