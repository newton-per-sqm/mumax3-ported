...
.visible .entry addexchange(
	...
	.param .u16 addexchange_param_16
)
{
	.reg .pred 	%p<22>;
	.reg .b16 	%rs<24>;
	...
	ld.param.u16 	%rs5, [addexchange_param_16];
...
$L__BB0_8:
	...
	mul.wide.s32 	%rd33, %r56, 2;
	add.s64 	%rd34, %rd2, %rd33;
	ld.global.nc.u16 	%rs9, [%rd34];
	min.u16 	%rs10, %rs9, %rs1;
	cvt.u32.u16 	%r57, %rs10;
	max.u16 	%rs11, %rs9, %rs1;
...
$L__BB0_11:
	...
	mul.wide.s32 	%rd41, %r66, 2;
	add.s64 	%rd42, %rd2, %rd41;
	ld.global.nc.u16 	%rs12, [%rd42];
	min.u16 	%rs13, %rs12, %rs1;
	cvt.u32.u16 	%r67, %rs13;
	max.u16 	%rs14, %rs12, %rs1;
...
$L__BB0_14:
	...
	ld.global.nc.f32 	%f81, [%rd48];
	ld.global.nc.f32 	%f82, [%rd46];
	ld.global.nc.f32 	%f83, [%rd47];
	mul.f32 	%f84, %f83, %f83;
	...
	min.u16 	%rs16, %rs15, %rs1;
	cvt.u32.u16 	%r78, %rs16;
	max.u16 	%rs17, %rs15, %rs1;
	cvt.u32.u16 	%r79, %rs17;
	add.s32 	%r80, %r79, 1;
...
$L__BB0_18:
	...
	ld.global.nc.f32 	%f95, [%rd56];
	ld.global.nc.f32 	%f96, [%rd54];
	ld.global.nc.f32 	%f97, [%rd55];
	mul.f32 	%f98, %f97, %f97;
	...
	mul.wide.s32 	%rd57, %r87, 2;
	add.s64 	%rd58, %rd2, %rd57;
	ld.global.nc.u16 	%rs18, [%rd58];
	min.u16 	%rs19, %rs18, %rs1;
	cvt.u32.u16 	%r88, %rs19;
	max.u16 	%rs20, %rs18, %rs1;
	cvt.u32.u16 	%r89, %rs20;
	add.s32 	%r90, %r89, 1;
...
$L__BB0_21:
	...
	ld.global.nc.f32 	%f109, [%rd64];
	ld.global.nc.f32 	%f110, [%rd62];
	ld.global.nc.f32 	%f111, [%rd63];
	...
	mul.wide.s32 	%rd65, %r98, 2;
	add.s64 	%rd66, %rd2, %rd65;
	ld.global.nc.u16 	%rs21, [%rd66];
	min.u16 	%rs22, %rs21, %rs1;
	cvt.u32.u16 	%r99, %rs22;
	max.u16 	%rs23, %rs21, %rs1;
	cvt.u32.u16 	%r100, %rs23;
	add.s32 	%r101, %r100, 1;
