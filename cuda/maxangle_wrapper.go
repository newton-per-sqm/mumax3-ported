...
$L__BB0_5:
	...
	ld.global.nc.f32 	%f41, [%rd21];
	ld.global.nc.f32 	%f42, [%rd19];
	ld.global.nc.f32 	%f43, [%rd20];
	mul.f32 	%f44, %f43, %f43;
...
$L__BB0_15:
	...
	mul.wide.s32 	%rd38, %r66, 2;
	add.s64 	%rd39, %rd2, %rd38;
	ld.global.nc.u16 	%rs12, [%rd39];
...
$L__BB0_20:
	...
	mul.wide.s32 	%rd46, %r77, 2;
	add.s64 	%rd47, %rd2, %rd46;
	ld.global.nc.u16 	%rs15, [%rd47];
...
$L__BB0_26:
	...
	ld.global.nc.f32 	%f183, [%rd51];
	ld.global.nc.f32 	%f184, [%rd52];
	...
	mul.wide.s32 	%rd54, %r87, 2;
	add.s64 	%rd55, %rd2, %rd54;
	ld.global.nc.u16 	%rs18, [%rd55];
...
$L__BB0_31:
	...
	mul.wide.s32 	%rd62, %r98, 2;
	add.s64 	%rd63, %rd2, %rd62;
	ld.global.nc.u16 	%rs21, [%rd63];
