...
.visible .entry adddmibulk(
	...
	.param .u16 adddmibulk_param_17,
	.param .u16 adddmibulk_param_18
)
{
	.reg .pred 	%p<64>;
	.reg .b16 	%rs<37>;
	...
	ld.param.u16 	%rs17, [adddmibulk_param_17];
	ld.param.u16 	%rs18, [adddmibulk_param_18];
...
$L__BB0_18:
	...
	ld.global.nc.u16 	%rs32, [%rd37];

$L__BB0_20:
	min.u16 	%rs21, %rs32, %rs1;
	cvt.u32.u16 	%r61, %rs21;
	max.u16 	%rs22, %rs32, %rs1;
	cvt.u32.u16 	%r62, %rs22;
	add.s32 	%r63, %r62, 1;
...
$L__BB0_29:
	...
	ld.global.nc.u16 	%rs33, [%rd46];

$L__BB0_31:
	min.u16 	%rs23, %rs33, %rs1;
	cvt.u32.u16 	%r70, %rs23;
	max.u16 	%rs24, %rs33, %rs1;
	cvt.u32.u16 	%r71, %rs24;
	add.s32 	%r72, %r71, 1;
...
$L__BB0_40:
	...
	ld.global.nc.u16 	%rs34, [%rd55];

$L__BB0_42:
	min.u16 	%rs25, %rs34, %rs1;
	cvt.u32.u16 	%r80, %rs25;
	max.u16 	%rs26, %rs34, %rs1;
...
$L__BB0_52:
	...
	mul.wide.s32 	%rd63, %r31, 2;
	add.s64 	%rd64, %rd3, %rd63;
	ld.global.nc.u16 	%rs35, [%rd64];

$L__BB0_54:
	min.u16 	%rs27, %rs35, %rs1;
	cvt.u32.u16 	%r89, %rs27;
	max.u16 	%rs28, %rs35, %rs1;
...
$L__BB0_63:
	...
	mul.wide.s32 	%rd72, %r36, 2;
	add.s64 	%rd73, %rd3, %rd72;
	ld.global.nc.u16 	%rs36, [%rd73];

$L__BB0_65:
	min.u16 	%rs29, %rs36, %rs1;
	cvt.u32.u16 	%r99, %rs29;
	max.u16 	%rs30, %rs36, %rs1;
	cvt.u32.u16 	%r100, %rs30;
	add.s32 	%r101, %r100, 1;
